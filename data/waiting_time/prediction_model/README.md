...
| **Metric**      | **RNN**     | **GRU** | **LSTM** |
| --------------- | ----------- | ------- | -------- |
| **Best Loss**   | **13.4247** | 14.9047 | 14.6243  |
| **Best Q Loss** | **0.3534**  | 0.3865  | 0.3841   |

| **Metric**      | **RNN_1** | **RNN_2**   | **GRU_1** | **GRU_2** | **LSTM_1** | **LSTM_2** |     |
| --------------- | --------- | ----------- | --------- | --------- | ---------- | ---------- | --- |
| **Best Loss**   | 27.2800   | **27.0163** | 30.2178   | 31.6792   | 36.4877    | 31.1202    |     |
| **Best Q Loss** | 0.4866    | **0.4682**  | 0.4879    | 0.4752    | 0.5095     | 0.4752     |     |
